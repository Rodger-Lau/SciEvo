...
class MSTI(nn.Module):
    ...
    def __init__(self, 
        ...
        self.cross_attn_x_t = CrossAttentionLayer(
            d_t, d_obser, d_obser, 
            cross_atten_dim, ffn_dim, n_heads, self.dropout, mask
        )
        ...
        self.self_attn_t_t = SelfAttentionLayer(
            h_dim, self_atten_dim, ffn_dim, n_heads, self.dropout, mask
        )
    ...
    def forward(self, x):
        ...
        self.cross_attn_x_t.p = self.dropout
        self.cross_attn_t_x.p = self.dropout
        self.cross_attn_x_s.p = self.dropout
        self.cross_attn_s_x.p = self.dropout
        self.self_attn_t_t.p = self.dropout
        self.self_attn_t_t1.p = self.dropout
        self.self_attn_s_s.p = self.dropout
        self.self_attn_s_s1.p = self.dropout
