...
class ASTGCN(BaseModel):
    ...
    '''
    def __init__(self, device, cheb_poly, order, nb_block, nb_chev_filter, nb_time_filter, time_stride, output_dim, **args):
        ...
        self.final_conv = nn.Conv2d(int(self.seq_len / time_stride), self.horizon*self.output_dim, kernel_size=(1, nb_time_filter))
